...
public class TodoItemController {
    private static final Logger log = LoggerFactory.getLogger(TodoItemController.class);
    ...
    public Iterable<TodoItem> getAllTodoItems(){
        log.info("Received GET request on /todo");
    ...
    public ResponseEntity<TodoItem> postTodoItem(@RequestBody TodoItem item){
        log.info("Received POST request on /todo with requestBody {}", item);
